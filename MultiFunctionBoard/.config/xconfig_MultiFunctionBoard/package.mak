...
override PKGDIR = xconfig_MultiFunctionBoard
...
package/%.xdc.inc package/%_xconfig_MultiFunctionBoard.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_MultiFunctionBoard" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: MultiFunctionBoard.pem4f

-include package/cfg/MultiFunctionBoard_pem4f.mak
-include package/cfg/MultiFunctionBoard_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/MultiFunctionBoard_pem4f.dep
endif
MultiFunctionBoard.pem4f: package/cfg/MultiFunctionBoard_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
MultiFunctionBoard.pem4f package/cfg/MultiFunctionBoard_pem4f.c: .libraries,em4f
endif

package/cfg/MultiFunctionBoard_pem4f.c package/cfg/MultiFunctionBoard_pem4f.h package/cfg/MultiFunctionBoard_pem4f.xdl: override _PROG_NAME := MultiFunctionBoard.xem4f
package/cfg/MultiFunctionBoard_pem4f.c: package/cfg/MultiFunctionBoard_pem4f.cfg
package/cfg/MultiFunctionBoard_pem4f.xdc.inc: package/cfg/MultiFunctionBoard_pem4f.xdl
package/cfg/MultiFunctionBoard_pem4f.xdl package/cfg/MultiFunctionBoard_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/MultiFunctionBoard_pem4f.cfg
	-$(RM) package/cfg/MultiFunctionBoard_pem4f.dep
	-$(RM) package/cfg/MultiFunctionBoard_pem4f.c
	-$(RM) package/cfg/MultiFunctionBoard_pem4f.xdc.inc

clean,em4f::
	-$(RM) MultiFunctionBoard.pem4f
.executables,em4f .executables: MultiFunctionBoard.xem4f

MultiFunctionBoard.xem4f: |MultiFunctionBoard.pem4f

-include package/cfg/MultiFunctionBoard.xem4f.mak
MultiFunctionBoard.xem4f: package/cfg/MultiFunctionBoard_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/MultiFunctionBoard_pem4f.oem4f   package/cfg/MultiFunctionBoard_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
MultiFunctionBoard.xem4f: export C_DIR=
MultiFunctionBoard.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
MultiFunctionBoard.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

MultiFunctionBoard.test test,em4f test: MultiFunctionBoard.xem4f.test

MultiFunctionBoard.xem4f.test:: MultiFunctionBoard.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 MultiFunctionBoard.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.MultiFunctionBoard.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,MultiFunctionBoard.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) MultiFunctionBoard.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
MultiFunctionBoard_pem4f.oem4f,copy : package/cfg/MultiFunctionBoard_pem4f.oem4f
MultiFunctionBoard_pem4f.sem4f,copy : package/cfg/MultiFunctionBoard_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_MultiFunctionBoard
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_MultiFunctionBoard.tar.dep
endif
package/rel/xconfig_MultiFunctionBoard/xconfig_MultiFunctionBoard/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_MultiFunctionBoard/xconfig_MultiFunctionBoard/package/package.rel.xml: package/build.cfg
package/rel/xconfig_MultiFunctionBoard/xconfig_MultiFunctionBoard/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_MultiFunctionBoard/xconfig_MultiFunctionBoard/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_MultiFunctionBoard.tar: package/rel/xconfig_MultiFunctionBoard.xdc.inc package/rel/xconfig_MultiFunctionBoard/xconfig_MultiFunctionBoard/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_MultiFunctionBoard.xdc.inc,package/rel/xconfig_MultiFunctionBoard.tar.dep)


release release,xconfig_MultiFunctionBoard: all xconfig_MultiFunctionBoard.tar
clean:: .clean
	-$(RM) xconfig_MultiFunctionBoard.tar
	-$(RM) package/rel/xconfig_MultiFunctionBoard.xdc.inc
	-$(RM) package/rel/xconfig_MultiFunctionBoard.tar.dep
